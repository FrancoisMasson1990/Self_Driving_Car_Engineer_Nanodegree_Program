...
## Data from the forest simualtor 
with open('/opt/Forest/driving_log.csv') as csvfile :
    reader = csv.reader(csvfile)
    for line in reader:
        lines.append(line)
...
plt.savefig("Model Mean Square Error Loss Lake 5.png")
#plt.show()
